...
The repository contains the analysis code. The version corresponding to the submitted dissertation is [release `thesis-submission-v1`](https://github.com/fjcallaghan/Dissertation-submission-computational-materials/releases/tag/thesis-submission-v1). Download `thesis-supplement-2026-09-07.zip`, extract it into an empty directory, and read `SUPPLEMENT-README.md`. Its numerical-date filename identifies the frozen numerical work; its manifest identifies the publication revision.
